                        ...
                        <div class="shop-sidebar">
                            ...
                            <div class="sidebar-widget post-widget">
                                ...
                                <div class="post-inner">
                                    ...
                                    <div class="post">
                                        <figure class="post-thumb"><a href="product-details/{{$item->slug}}"><img src="{{uploaded_asset($item->image)}}" alt="Fabric India"></a></figure>
                            ...
                            <div class="advice-box centred">
                                <div class="inner">
                                    ...
                                    <div>
                                     <img src="frontend_css/assets/images/question.png">
                                    </div>
                                    <h2><a href="tel:+91-9451075410" class="cont">Call: +91-9451075410</a></h2>
                                    <span><a href="mailto:indianfabric@gmail.com" class="none">indianfabric@gmail.com</a></span>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="product-block-two">
                                <div class="inner-box">
                                    <figure class="image-box">
                                        <img src="{{uploaded_asset($item->image)}}" alt="Fabric India">
                                    ...
                                    <div class="content-box">
                                        ...
                                        <div class="link"><a href="product-details/{{$item->slug}}" class="theme-btn-one">View Details<i class="far fa-long-arrow-right"></i></a></div>
                                    </div>
                                </div>
                            </div>
                            @empty
                                <div class="text-center">
                                        <img src="{{ asset('frontend_css/assets/images/no-product-found.jpg')}}" alt="Fabric India">
                                </div>
                            @endforelse
                        </div>
                    </div>
